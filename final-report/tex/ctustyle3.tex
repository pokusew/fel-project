...
\_def\.abstractpage{
	...
	\_insertoutline{Abstract} % TODO: \_insertoutline{Abstract/Abstrakt}
	\.frontpage[Abstract/]    % TODO: \.frontpage[Abstract/Abstrakt]
	\_else
...
% NOTE: I disabled short citations. But if (in the future) there is a lot of consecutive citations
%       it might be needed to re-enable it.
% \_shortcitations
\_def\dprime{"}
\_activettchar"
