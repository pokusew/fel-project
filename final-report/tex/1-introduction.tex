...
migrating applications from ROS~1 to ROS~2 and benefit from the new possibilities.
...
Gap application is selected for migration to ROS~2. The migration is described in Chapter~\ref[follow_the_gap].
...
among many students and researchers. Thus, boot options of the Jetson modules are explored. Then a~solution
