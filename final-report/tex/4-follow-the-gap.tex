...
solutions like "dynamic_reconfigure"\urlnote{https://wiki.ros.org/dynamic_reconfigure} to get similar features.
...
will act as “global parameter storage” and will store global car model configuration (such as sensors types)
...
\caption/f Running Follow the Gap application in the Stage simulator in ROS~2 on~Ubuntu~20.04 (as a~VM on~macOS)
\endinsert
...
\caption/f Running Follow the Gap application in the Stage simulator in ROS~2 \hbox{on~macOS~10.14.6}
\endinsert
